...
assertThat(optional.isEmpty()) — confirms that the Optional is empty.

Such assertions are useful for testing methods that may return absent values and ensuring they behave predictably when no result is present.
