...
This project includes an example that demonstrates how to test whether a Map in Java contains a specific key:

assertThat(map.containsKey(key)) — checks that the map includes the expected key after insertion.

This is a useful assertion when validating logic that adds entries to maps such as HashMap, ensuring data is indexed correctly.
