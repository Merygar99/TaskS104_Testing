...
This project includes an example of using JUnit assertions to verify that two int[] arrays are identical in content and order:

✅ assertThat(actualArray).isEqualTo(expectedArray) — checks whether two integer arrays contain the same elements in the same sequence.

This type of assertion is especially useful when testing sorting algorithms, matrix operations, or any functionality that returns arrays.
