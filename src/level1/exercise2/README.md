...
Create a class named CalculateId that calculates the corresponding letter of a ID number given its numeric part as a parameter.

Additionally, implement a JUnit test class to verify the correct behavior of CalculateId. The test should be parameterized to cover a broad range of input values and validate the correctness of the calculation using 10 predefined ID numbers.
